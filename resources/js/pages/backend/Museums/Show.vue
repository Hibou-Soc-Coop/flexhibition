        ...
        <PageLayout title="Dettaglio Museo">
            <template #button>
                <div class="flex gap-2">
                    <Button
                        @click="router.visit(museumsRoutes.edit.url(props.museum.id))"
                        color-scheme="edit"
                    >
                        Modifica Museo
                    </Button>
            ...
            <div class="grid grid-cols-[1fr_4fr] grid-rows-[auto_auto] gap-4 dark:text-white">
                <div class="rounded-lg border p-4 shadow dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <div
                        class="flex max-h-80 items-center justify-center overflow-hidden rounded-md border border-gray-300 bg-gray-50 dark:border-gray-600 dark:bg-gray-900"
                    >
                        <img
                            v-if="logo?.url"
                            :src="logo.url"
                        ...
                        <div
                            v-else
                            class="flex h-40 w-full items-center justify-center text-gray-400 dark:text-gray-500"
                        >
                            Nessun logo
                        </div>
                    </div>
                ...
                >
                    ...
                    >
                    <audio
                        v-if="audio?.[currentLangCode]?.url"
                        :src="audio?.[currentLangCode]?.url ?? undefined"
                        controls
                        class="mt-2 w-full"
                    />
                    <div
                        v-else
                        class="mt-2 w-full rounded-md border border-gray-300 bg-gray-100 p-4 text-sm text-gray-500 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-400"
                    >
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <p
                                class="mb-6 flex min-h-9 w-full items-center rounded-md border border-input px-3 py-1 text-sm shadow-xs shadow-input dark:border-gray-600 dark:bg-gray-900 dark:text-white"
                            >
                                {{ props.museum.name[language.code] }}
                            </p>
                            <Label class="mb-2 block font-semibold dark:text-gray-200">
                            ...
                            <div
                                class="prose dark:prose-invert mb-2 flex min-h-15 w-full max-w-none items-center rounded-md border border-input px-3 py-1 text-sm shadow-xs shadow-input dark:border-gray-600 dark:bg-gray-900 dark:text-white"
                ...
                >
                    ...
                    <div class="grid grid-cols-2 gap-4 md:grid-cols-4 lg:grid-cols-5">
                        <div
                            ...
                            :key="index"
                            class="aspect-square w-full overflow-hidden rounded-md border border-gray-300 bg-gray-50 dark:border-gray-600 dark:bg-gray-900"
                        >
                            <img
                                v-if="image.url"
                                :src="image.url"
                                :alt="image.custom_properties?.title || ''"
                                class="h-full w-full object-cover"
                            />
                        </div>
                        <div
                            v-if="gallery.length === 0"
                            class="col-span-full py-4 text-center text-gray-500 dark:text-gray-400"
                        >
