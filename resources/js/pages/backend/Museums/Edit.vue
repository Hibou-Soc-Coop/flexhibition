...
const form = useForm({
    name: props.museum.name ?? { ...emptyContentByLanguage },
    description: props.museum.description ?? { ...emptyContentByLanguage },
    logo: props.museum.logo ?? ({ ...emptyMediaData } as MediaData | null),
    audio: props.museum.audio ?? ({ ...emptyMediaDataLocalized } as MediaDataLocalized),
        ...
        <PageLayout title="Modifica Museo">
            ...
            <form @submit.prevent="submit">
                <div class="grid grid-cols-[1fr_4fr] grid-rows-[auto_auto] gap-4 dark:text-white">
                    ...
                    >
                        <h2 class="mb-4 text-lg font-semibold dark:text-gray-200">
                            Informazioni Museo
                        </h2>
                        <Tabs
                            v-model="currentLang"
                        ...
                        >
                            <TabsList class="grid h-fit w-full grid-cols-1 gap-2 dark:bg-gray-800">
                                <TabsTrigger
                                    ...
                                    :key="language.code"
                                    :value="language.code"
                                    class="dark:text-gray-300 dark:data-[state=active]:bg-gray-700"
                                >
                                    {{ language.name }}
                                </TabsTrigger>
                            </TabsList>
